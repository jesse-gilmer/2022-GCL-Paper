...
for gw = [1 2 3 4 5:5:15 25:25:100 200:100:1000]
    for p = [1 0.0011 .001 .01 .05 .1:.1:.9]
        ...
        save("Rand_STS/rX_STS" + ntr+ "trials_3000popgc_50mf_typeOU_ouTarget_t1000_gaus" + gw + "_pop" + p + "_seed_" + randi([1 1000000],1,1) + "_seed2_" + randi([1 1000000],1,1) + ".mat")
    end
end
