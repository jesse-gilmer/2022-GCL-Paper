...
clear all
close all
for T = repmat([100],1,2)
    for A = [-2:.1:2]
        clearvars -except T A
        warning('off')
        
        save_dir = 'PCA_Test_3000F_retest/';
        mkdir(save_dir)
    ...
    %     [T A]
    save(save_dir + "Indep_PARAMS_t_" + (ntr) + "trials_threshold_" + A + "seed_" + randi([1 1000000],1,1) + "seed2_" + randi([1 1000000],1,1) + ".mat")
