...
% (https://www.mathworks.com/matlabcentral/fileexchange/3218-mtit-a-pedestrian-major-title-creator)
% and slightly edited by Matteo Mischiati (MM) in February 2020
...
% ...and title
        ...
        % MM modification 2/7/20: I added this line to prevent the title to rotate in place of the subplots, in 3d figures
        %set(xh,'Interactions',[]);
...
% ...and axis' order
% MM modification 2/7/20: I commented following line because otherwise
% after creating an 'mtit' over a figure with multiple subplots, the last
% subplot was not rescale the same way as the other ones...
        %axes(oah);				%#ok 		
        uistack(xh,'bottom');
